...
// RunPropertyAssignmentTestForUser tests if a specific instance of User can be assigned to v1api20220801storage and back losslessly
...
// RunPropertyAssignmentTestForService_User_Spec tests if a specific instance of Service_User_Spec can be assigned to v1api20220801storage and back losslessly
...
// RunPropertyAssignmentTestForService_User_STATUS tests if a specific instance of Service_User_STATUS can be assigned to v1api20220801storage and back losslessly
...
// RunPropertyAssignmentTestForGroupContractProperties_STATUS tests if a specific instance of GroupContractProperties_STATUS can be assigned to v1api20220801storage and back losslessly
...
// RunPropertyAssignmentTestForUserIdentityContract tests if a specific instance of UserIdentityContract can be assigned to v1api20220801storage and back losslessly
...
// RunPropertyAssignmentTestForUserIdentityContract_STATUS tests if a specific instance of UserIdentityContract_STATUS can be assigned to v1api20220801storage and back losslessly
